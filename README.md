...
[`build`](plugins/build.lua?raw=1) | Provides an easy interface to work with a makefile, or other build tool. Shows clickable build messages that allow you to easily jump to errors in a file.
